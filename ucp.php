...
$lang = array_merge($lang, array(
	...
	當您使用「%1$s」(以下以「我們」、「我們的」、「%1$s」、「%2$s」代表) 時，即表示您已同意接受本服務條款之所有內容。如果您不同意本服務條款的內容，請您停止存取和/或使用「%1$s」。我們或許會於任何時間修改或變更本服務條款之內容，雖然我們也會盡力通知您任何條款的修改或變更，但仍建議您在使用「%1$s」時隨時注意是否有修改或變更。您於任何修改或變更後繼續使用本服務，將視為您已同意接受該條款的修改或變更。
	<br /><br />
	我們的討論區使用的是 phpBB (以下以「他們」、「他們的」、「phpBB 軟體」、「www.phpbb.com」、「phpBB Group」、「phpBB Teams」代表)，該討論版系統是以「<a href="http://opensource.org/licenses/gpl-license.php">GNU General Public License</a>」(以下以「GPL」代表) 授權釋出並且可以從 <a href="http://www.phpbb.com/">www.phpbb.com</a> 下載取得。phpBB 軟體僅協助網路上的討論以及交流，phpBB Group 無須對我們允許或不允許的內容或行為舉止負責。
	如果您想知道更多有關 phpBB 的資訊，請前往：<a href="http://www.phpbb.com/">http://www.phpbb.com/</a>。
	<br /><br />
	您同意不發表任何誹謗、侮辱、具威脅性、攻擊性、不雅、猥褻、不實、違反公共秩序或善良風俗、或其他違反香港特別行政區法律或國際公法之文字、圖片或任何形式的檔案於本服務上。如果您觸犯了以上的規定，我們將會立即並且永久的限制您的進入。在必要的情況下，您的ISP也會收到我們的通知。所有發表文章的 IP 位址都將被記錄儲存以防止任何的違法情節發生。您同意「%1$s」有權在任何時間移除、修改、移動或關閉任何主題的權力。作為一個使用者，您同意您所提供的任何資訊都將被存入資料庫中。這些資訊在您尚未允許前將不會提供給任何第三方公司，對於因駭客入侵所造成的資料外洩以及其損失，
	「%1$s」和 phpBB 不負任何賠償責任。
	<br /><br />
	「%1$s」以即時上載留言的方式運作，本網站對所有用戶上載的內容(包括但不限於圖片、網頁、文字、影像、音效及程式) 的真實性、完整性及立場等，不會負上任何法律責任。受運作方式限制，管理員不能完全監察所有留言，如發現任何問題，請盡快聯絡我們以便跟進。
	',

	'PRIVACY_POLICY'      => '
	這個隱私權保護政策說明「%1$s」以及其相關網站 (以下以「我們」、「我們的」、「%1$s」、「%2$s」代表) 以及 phpBB (以下以「他們」、「他們的」、「phpBB 軟體」、「www.phpbb.com」、「phpBB Group」、「phpBB Teams」代表) 如何處理當會員使用本服務時收集到的個人資料 (以下以「您的個人資料」、「個人資料」代表)。
	<br /><br />
	...
	<br /><br />
	您的帳號的主要資訊為：一個獨特的識別名稱 (以下以「您的會員名稱」代表)，一個讓您登入到您的帳號的個人密碼 (以下以「您的密碼」代表) 以及一個有效的個人 e-mail 位址 (以下以「您的 e-mail」代表)。在「%1$s」中，您的帳號所包含的個人資料是由這個網站所在國家或地域的資料保護法所保護。除了您的會員名稱、您的密碼以及您的 e-mail 以外，我們有權決定哪一些額外資訊是您必須或非必須提供給「%1$s」的。這些非必須的額外資訊，您有權決定哪一些資訊是可以對外公開的。除此之外，在您的帳號中，您可以選擇是否要接收來自 phpBB 軟體內部所寄發的電子信件。
	<br /><br />
	您的密碼已經被加密處理。但我們建議您不要在多個網站重複使用相同的密碼。您的密碼是讓您在「%1$s」存取以及使用您的帳號的方法，請您務必要小心保護它。此外，不論在何種情況下「%1$s」、phpBB 或是任何第三方公司的任何人都不會跟您索取您的密碼。如果您忘記了您的帳號的您的密碼，您可以使用 phpBB 軟體提供的「我忘記了自己的密碼」功能。這個程序將會要求您提供您的會員名稱以及您的 e-mail，之後 phpBB 軟體會幫您產生一組新的密碼以讓您繼續使用您的帳號。<br />
	',
));
