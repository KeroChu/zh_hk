...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> '正體中文語系由 <a href="http://phpbb-tw.net/" onclick="window.open(this.href);return false;"><span style="color:#ff6633"><strong>竹貓星球</strong></span></a> 維護製作<br />Hongkongized by HKGoDun Admin.',
	'DIRECTION'			=> 'ltr',
	...
	'ACCOUNT_DEACTIVATED'	=> '您的帳號已經被停用，只有管理員才能重新啟用。',
	'ACCOUNT_NOT_ACTIVATED'	=> '您的帳號尚未啟用',
	'ACP'	=> '管理員控制台 (ACP)',
	'ACTIVE'	=> '啟用',
	'ACTIVE_ERROR'	=> '您指定了一個尚未啟用的會員名稱。如果您有啟用帳號上的問題，請聯絡管理員以尋求協助。',
	'ADMINISTRATOR'	=> '管理員',
	'ADMINISTRATORS'	=> '管理員',
	'AGE'	=> '年齡',
	'AIM'							=> 'AIM',
	...
	'BCC'	=> '密件副本',
	'BIRTHDAYS'	=> '生日',
	'BOARD_BAN_PERM'	=> '您的帳戶已被<strong>永久地</strong>凍結。',
	'BOARD_BAN_REASON'	=> '凍結理由是：<strong>%s</strong>',
	'BOARD_BAN_TIME'	=> '您被這個討論區凍結，直到 <strong>%1$s</strong> 為止。',
	...
	'G_GLOBAL_MODERATORS'	=> '總版主',
	'G_NEWLY_REGISTERED'		=> '新會員',
	...
	'IMAGE_FILETYPE_MISMATCH'	=> '圖檔類型不符：MIME類型是 %1$s ，但您提供的是 %2$s。',
	'IN'	=> '位於',
	'INDEX'	=> '首頁',
	'INFORMATION'	=> '系統訊息',
	'INTERESTS'	=> '興趣',
	...
	'IP'						=> 'IP',
	'IP_BLACKLISTED'	=> '您的 IP %1$s 已經被封鎖。細節請參考 <a href="%2$s">%2$s</a>。',
	...
	'LOGIN_CONFIRM_EXPLAIN'            => '為了防止暴力破解會員帳號，論壇將會要求您在超過最大嘗試登入次數後輸入一組確認代碼，確認代碼顯示在如下所示的圖檔中。如果您有視覺相關問題因而無法瀏覽判斷時，請聯絡 %s管理員%s。', // 不使用的
	...
	'NA'						=> 'N/A',
	'NEWEST_USER'	=> '新會員：<strong>%s</strong>',
	'NEW_MESSAGE'	=> '新訊息',
	'NEW_MESSAGES'	=> '新訊息',
